...
"""
TF/Caffe2 (eps inside sqrt): https://github.com/pytorch/pytorch/blob/v0.4.0/caffe2/sgd/rmsprop_op_gpu.cu#L24
PyTorch (eps outside sqrt): https://github.com/pytorch/pytorch/blob/v0.4.0/torch/optim/rmsprop.py#L93
