...
def vis_image_mask_bbox_cv2(img, masks, bboxes=None, labels=None,
        font_scale=0.5, text_color="green", font_thickness=2, box_thickness=1):
    '''
    bboxes: xyxy
    '''
    # import pycocotools.mask as cocomask
    ...
    for i, mask in enumerate(masks):
        ...
        if labels is not None:
            label_text = labels[i]
            cv2.putText(img_show, label_text, (x1, max(y1 - 2, 5)),
