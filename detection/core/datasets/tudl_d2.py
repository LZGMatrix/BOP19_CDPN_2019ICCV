...
class TUDL_Dataset(object):
    ...
    def __init__(self, data_cfg):
        ...
        self.dataset_root = data_cfg["dataset_root"]  # BOP_DATASETS/tudl/train_real
        self.scene_ids = data_cfg.get('scene_ids', [1, 2, 3])
...
def get_tudl_metadata(obj_names):
...
SPLITS_TUDL = dict(
    tudl_train_real=dict(
        ...
        objs=ref.tudl.objects,  # selected objects
        scene_ids=[1, 2, 3],
...
for obj in ref.tudl.objects:
    name = "tudl_{}_train_real".format(obj)
    select_objs = [obj]
...
def register_with_name_cfg(name, data_cfg=None):
    ...
    MetadataCatalog.get(name).set(
        ...
        **get_tudl_metadata(obj_names=used_cfg["objs"]),
    )
