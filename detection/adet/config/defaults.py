...
###### INPUT ####
_C.INPUT.COLOR_AUG_ON = False
_C.INPUT.COLOR_AUG_TYPE = "ROI10D"  # ROI10D | CODE | AAE | SSD
_C.INPUT.COLOR_AUG_CODE = ""
_C.INPUT.WITH_DEPTH = False
# bg images
_C.INPUT.BG_TYPE = "coco"
_C.INPUT.BG_IMGS_ROOT = "datasets/coco/train2017/"
_C.INPUT.NUM_BG_IMGS = 10000
...
###### SOLVER ########
_C.SOLVER.OPTIMIZER_NAME = "SGD"  # SGD | Adam | Ranger | RMSprop
# NOTE: use string code to get cfg dict like mmdet
# will ignore OPTIMIZER_NAME, BASE_LR, MOMENTUM, WEIGHT_DECAY
_C.SOLVER.OPTIMIZER_CFG = ""

_C.SOLVER.LR_SCHEDULER_NAME = "WarmupMultiStepLR"  # WarmupMultiStepLR | Flat_And_Anneal
_C.SOLVER.ANNEAL_METHOD = "step"  # step | cosine | linear | poly | exp
_C.SOLVER.ANNEAL_POINT = 0.72  # start point for anneal phase, not valid for step method
_C.SOLVER.POLY_POWER = 0.9  # poly power
# NOTE: set MAX_ITER according to TOTAL_EPOCHS and len(train_loader)
_C.SOLVER.TOTAL_EPOCHS = 12  # NOTE: ignore MAX_ITER
_C.SOLVER.REL_STEPS = (2 / 3, 8 / 9)  # relative step points, NOTE: ignore STEPS
_C.SOLVER.GRAD_CLIP_NORM = True  # False
_C.SOLVER.GRAD_CLIP_NORM_TYPE = 2
_C.SOLVER.GRAD_CLIP_NORM_MAX = 5.0  # 35.0 ??
_C.SOLVER.FILTER_NAN_GRAD = False  # set NaN grads to 0
# Save a checkpoint after every this number of iterations/epochs
_C.SOLVER.CHECKPOINT_PERIOD = 1
_C.SOLVER.CHECKPOINT_BY_EPOCH = True
_C.SOLVER.NUM_CKPT_KEEP = 8  # eg. set to 5 to keep last 5 checkpoints, -1 to keep all
